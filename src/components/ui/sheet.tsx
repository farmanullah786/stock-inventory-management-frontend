  ...
  <SheetPortal>
    ...
    >
      ...
      <SheetPrimitive.Close
        id="close-sheet"
        className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 hover:bg-primary/10 hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-primary/10 data-[state=open]:text-primary"
      >
        <X className="h-4 w-4" />
